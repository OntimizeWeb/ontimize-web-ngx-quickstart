...
import { OFormComponent, OntimizeService, OListPickerComponent, OTableComponent, ORealPipe, ONIFInputComponent, O_REPORT_SERVICE } from 'ontimize-web-ngx';
...
export class CustomersDetailComponent implements OnInit {
  ...
  fillReport(e: Event) {
    this.reportService.openFillReport("6e1439f4-9b76-4d2d-ae73-6797682078c9", this.params, {});
  }
