...
import { FilterExpressionUtils, Expression, OFormComponent, OListComponent, OFilterBuilderComponent, IReportService, O_REPORT_SERVICE } from 'ontimize-web-ngx';
...
export class AccountsHomeComponent implements OnDestroy {
  ...
  constructor(changeDetectorRef: ChangeDetectorRef,
    media: MediaMatcher,
    private reportService: OReportStoreService) {
  ...
  fillReportFilter() {
    ...
    this.reportService.openFillReport("2abdb71f-6ea7-4d13-b255-b0df406c8f0b", {}, filter);
  }
