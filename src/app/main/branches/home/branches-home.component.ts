...
export class BranchesHomeComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    this.button.onClick.subscribe(event => {
      this.reportService.openFillReport("96c0aa72-2582-4aa4-a93a-afe34acb77c6", {}, {});
    });
  }
  ...
  onDataLoaded(e: object) {
    ...
    this.detailButton.onClick.subscribe(event => {
      this.reportService.openFillReport("1685066d-97ee-4b1e-a18a-278dabc5c7a0", this.params, {});
    });
  }
